...
export const env = {
  ...
  WECHAT_AUTH_MOCK: readEnv("WECHAT_AUTH_MOCK"),
  WECHAT_AUTH_REDIRECT_URI: readEnv("WECHAT_AUTH_REDIRECT_URI"),
  WECHAT_GROUP_QR_MEDIA_ID: readEnv("WECHAT_GROUP_QR_MEDIA_ID"),
  WECHAT_CONTACT_QR_MEDIA_ID: readEnv("WECHAT_CONTACT_QR_MEDIA_ID"),
  WECHAT_SAMPLE_VIDEO_MEDIA_ID: readEnv("WECHAT_SAMPLE_VIDEO_MEDIA_ID"),
  WECHAT_SAMPLE_COVER_MEDIA_ID: readEnv("WECHAT_SAMPLE_COVER_MEDIA_ID"),
