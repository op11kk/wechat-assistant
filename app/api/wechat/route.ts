...
function buildAboutUsReplyContent(): string {
  return [
    ...
    "- 报酬清晰，结算准时：任务单价固定为1元/分钟，每天下午5:00统一结算",
    "- 结果公开可见：每天下午6:00群内公示当日结算总表，产出和收益真实可查",
  ].join("\n");
}
...
function buildGuideReplyContentV2(): string {
  return [
    ...
    "3. 点击菜单【上传视频】提交视频素材。",
    "4. 点击菜单【其他】可查看加入社群、项目介绍、拍摄标准、结算规则和联系客服方式。",
  ].join("\n");
}
